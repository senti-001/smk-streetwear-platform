...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'p39',
    slug: 'self-made-king-drip-tee-white',
    name: 'Self Made King Drip Tee (White)',
    price: 55,
    compareAtPrice: 75,
    collection: 'new-drops',
    category: 'Tops',
    image: '/products/smk_white_shoot_detail.png',
    images: ['/products/smk_white_shoot_detail.png', '/products/smk_white_shoot_front.png'],
    colors: ['White'],
    sizes: ['L', 'XL', '2XL', '3XL'],
    description:
      'The Self Made King Drip Tee in White. Features a bold dripping gothic SELF MADE KING back print and subtle sleeve hit. Heavyweight street fit.',
    details: [
      '100% Cotton',
  ...
  {
    id: 'p40',
    slug: 'self-made-king-drip-tee-black',
    name: 'Self Made King Drip Tee (Black)',
    price: 55,
    compareAtPrice: 75,
    collection: 'new-drops',
    category: 'Tops',
    image: '/products/smk_shoot_back_no_glare.png',
    images: ['/products/smk_shoot_back_no_glare.png', '/products/smk_shoot_front.png'],
    colors: ['Black'],
    sizes: ['L', 'XL', '2XL', '3XL'],
    description:
      'The Self Made King Drip Tee in Black. Features a bold dripping gothic SELF MADE KING back print and subtle sleeve hit. Heavyweight street fit.',
    details: [
      '100% Cotton',
      '250 GSM Heavyweight Fabric',
      'Oversized Street Fit',
